...
public class GcmWithBouncyCasteleOnJDK17Test {
    ...
    @Test
    public void testTlsGCM() throws KeyManagementException, NoSuchAlgorithmException, IOException,
            NoSuchProviderException, NoSuchPaddingException, KeyStoreException, CertificateException {
        ...
        System.out.println("supportedCipherSuites: " + supportedCipherSuites.length);
        System.out.println("acceptedCipers: " + acceptedCiphers);
